# Guía del Participante — Datathon Grupo Pichincha · Equipo **DEUNA**
...
| Empresa | Tu tabla |
|---|---|
| Deuna | `deuna.clean_room.comercios_deuna` |
...
- **Tu equipo debe descubrir cómo crear el Clean Room** e invitar a las otras empresas
  (Banco y Seguros) — **es parte del reto**. No hay guía paso a paso: investiga en la
  documentación de Databricks y experimenta.
...
| 9:00 | Setup + montar el Clean Room |
| 10:00 | Hacking |
| 12:30 | Almuerzo |
...
- *"Cruza mi tabla con la del banco por id_cliente_hash y muéstrame los dueños de comercio sin seguro."*
- *"Entrena un modelo que prediga prob_desercion usando las señales del banco."*
